                    ...
                    <div class="card-body p-sm-5">
                        ...
                        @if (session()->has('success'))
                            <div class="alert alert-success">
                                <h4 class="fs-13 fw-bold mb-2">{{ session('success') }}</h4>
                            </div>
                        @endif

                        @if (session()->has('loginError'))
                            <div class="alert alert-danger">
                                <h4 class="fs-13 fw-bold mb-2">{{ session('loginError') }}</h4>
                            </div>
                        @endif
                        ...
                        <form action="/login" method="POST" class="w-100 mt-4 pt-2">
                            ...
                            <div class="mb-4">
                                <input type="email" name="email" class="form-control"
                                    placeholder="Email or Username" value="wrapcode.info@gmail.com" autofocus required>
                            </div>
                            <div class="mb-3">
